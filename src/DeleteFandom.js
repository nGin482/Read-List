...
const DeleteFandom = ({fandomName, openDelete, setOpenDelete, message, setMessage}) => {
    ...
    return (
        <Modal isOpen={openDelete} id="delete-fandom-modal">
            ...
            <p className="message" id="delete-fandom-question">Are you sure you want to delete {fandomName} from the archives list?</p>
            ...
            <p className="message" id="delete-fandom-message">{message}</p>
        </Modal>
    )
}
